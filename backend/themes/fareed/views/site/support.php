<link rel="stylesheet" href="<?php echo Yii::$app->view->theme->baseUrl; ?>/fareed/vendor/css/pages/page-faq.css" />
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative">
            <img src="<?php echo Yii::$app->view->theme->baseUrl; ?>/fareed/img/pages/header.png" class="scaleX-n1-rtl faq-banner-img" alt="background image">
            ...
            <div class="col-lg-3 col-md-4 col-12 mb-md-0 mb-3">
                <div class="d-flex justify-content-between flex-column mb-2 mb-md-0">
                    ...
                    <div class="d-none d-md-block">
                        <div class="mt-5">
                            <img src="<?php echo Yii::$app->view->theme->baseUrl; ?>/fareed/img/illustrations/sitting-girl-with-laptop-light.png" class="img-fluid w-px-200" alt="FAQ Image" data-app-light-img="illustrations/sitting-girl-with-laptop-light.png" data-app-dark-img="illustrations/sitting-girl-with-laptop-dark.png">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row text-center justify-content-center gap-sm-0 gap-3">
            <div class="col-sm-6">
                <div class=" py-3 rounded bg-faq-section text-center">
                    ...
                    <h4 class="mb-2"><a class="h4" href="tel:+917207556743">+91 720 755 6743 </a></h4>
            ...
            <div class="col-sm-6">
                <div class=" py-3 rounded bg-faq-section text-center">
                    ...
                    <h4 class="mb-2"><a class="h4" href="mailto:support@walletplus.in">support@walletplus.in</a></h4>
